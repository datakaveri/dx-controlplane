...
public interface ActivityLogService {
   ...
   */
  Future<PaginatedResult<ActivityAuditLogEntity>> getActivityLogByUserId(ActivityLogRequest activityLogRequest);
   ...
   */
  Future<PaginatedResult<ActivityAuditLogEntity>> getAllActivityLogsForAdmin(PaginatedRequest paginatedRequest);
   ...
   */
  Future<Void> insertActivityLogIntoDb(ActivityAuditLogEntity activityLogEntity);
   ...
   */
  Future<PaginatedResult<ActivityAuditLogEntity>> getActivityLogForConsumer(PaginatedRequest paginatedRequest);
}