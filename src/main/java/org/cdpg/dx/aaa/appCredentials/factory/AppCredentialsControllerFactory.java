...
public class AppCredentialsControllerFactory {
  ...
  public static AppCredentialsController create(
      PostgresService postgresService,
      OrganizationService organizationService,
      ItemService itemService,
      URNGenerator urnGenerator,
      DataBrokerService dataBrokerService,
      String appIdRevokeExchange,
    ...
    DelegationValidator delegationValidator =
        new DelegationValidator(organizationService, itemService);
    ...
    AppCredentialsHandler appCredentialsHandler =
        new AppCredentialsHandler(appCredentialsService, delegationHandlerValidator, urnGenerator);
