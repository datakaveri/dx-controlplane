...
public class AppCredentialsControllerFactory {
  ...
  public static AppCredentialsController create(PostgresService postgresService, OrganizationService organizationService, ItemService itemService, URNGenerator urnGenerator, DataBrokerService dataBrokerService, String appIdRevokeExchange, AuthHandlersV2 authV2) {
