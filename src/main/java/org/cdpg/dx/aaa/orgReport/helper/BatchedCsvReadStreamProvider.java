package org.cdpg.dx.aaa.orgReport.helper;
...
public class BatchedCsvReadStreamProvider implements ReadStream<Buffer> {
  private static final Logger LOGGER = LogManager.getLogger(BatchedCsvReadStreamProvider.class);
  private final ProviderRoleRequestDAO dao;
  private final CsvGeneratorProvider generator;
  ...
  public BatchedCsvReadStreamProvider(
          ProviderRoleRequestDAO dao, CsvGeneratorProvider generator, Vertx vertx, PaginatedRequest paginatedRequest) {
    this.dao = dao;
