...
public class BatchedCsvReadStreamOrg implements ReadStream<Buffer> {
  private static final Logger LOGGER = LogManager.getLogger(BatchedCsvReadStreamOrg.class);
  private final OrganizationDAO dao;
  private final CsvGeneratorOrg generator;
  ...
  public BatchedCsvReadStreamOrg(
          OrganizationDAO dao, CsvGeneratorOrg generator, Vertx vertx, PaginatedRequest paginatedRequest) {
    this.dao = dao;
