...
public class BatchedCsvReadStreamCompute implements ReadStream<Buffer> {
  private static final Logger LOGGER = LogManager.getLogger(BatchedCsvReadStreamCompute.class);
  private final ComputeRoleDAO dao;
  private final CsvGeneratorCompute generator;
  ...
  public BatchedCsvReadStreamCompute(
          ComputeRoleDAO dao, CsvGeneratorCompute generator, Vertx vertx, PaginatedRequest paginatedRequest) {
    this.dao = dao;
