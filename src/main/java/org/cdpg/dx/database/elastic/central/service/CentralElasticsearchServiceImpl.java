package org.cdpg.dx.database.elastic.central.service;
...
public class CentralElasticsearchServiceImpl implements CentralElasticsearchService {
  private static final Logger LOGGER = LogManager.getLogger(CentralElasticsearchServiceImpl.class);

  static ElasticClient client;
  private static ElasticsearchAsyncClient asyncClient;

  public CentralElasticsearchServiceImpl(ElasticClient client) {
    CentralElasticsearchServiceImpl.client = client;
