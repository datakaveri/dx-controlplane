...
@VertxGen
@ProxyGen
public interface CentralElasticsearchService {
  @GenIgnore
  static CentralElasticsearchService createProxy(Vertx vertx, String address) {
    return new CentralElasticsearchServiceVertxEBProxy(vertx, address);
  }
